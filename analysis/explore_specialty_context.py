...
def main() -> int:
    ...
    payload = {
        ...
        "notes": (
            ...
            "npi-taxonomy-correctness.json were computed the same way and were "
            "recomputed across the full arrays on 2026-08-28; the flattened "
            "column now has a pipe-joined _specialty_codes companion. "
