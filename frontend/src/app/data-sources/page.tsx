...
const FEDERAL_SCREENING: SourceRow[] = [
  ...
  },
  {
    ...
    license: 'Public; programmatic access requires free SAM.gov API key',
    cadence: 'Daily',
    ainpiStatus: 'roadmap',
    mappedTo: 'Future H25 — pending API key registration',
    notes: 'Bulk CSV requires SAM.gov account. Once SAM_GOV_API_KEY is provisioned in GitHub Actions secrets, the ingestion mirrors the LEIE pipeline.',
  },
  {
