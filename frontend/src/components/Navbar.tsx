...
import { LogOut, User, Map, FileText, MapPin, BookOpen, Code2, LayoutGrid, IdCard, Stethoscope, Landmark, GraduationCap, Compass, Search } from 'lucide-react';
...
const NAV_ITEMS: { href: string; label: string; icon: React.ReactNode }[] = [
  ...
  { href: '/find', label: 'Find care', icon: <Search className="w-4 h-4 mr-1.5" /> },
