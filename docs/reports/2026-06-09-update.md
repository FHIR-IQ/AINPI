...
> release. The finding that practitioners carry a phone directly on the record
> still holds at 2026-08-20, at 99.97%. The claim below that the location path
> returns nothing does not: `Location.telecom` was empty in May and now carries
> a phone for 79.0% of the 2,535,686 location records. See
> [the 2026-08-21 update](/reports/2026-08-21-update) for what changed.
